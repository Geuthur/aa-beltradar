...
from beltradar.api.helpers.core import get_owner_or_none
...
class BeltRadarSurveyApiEndpoints:
    ...
    def __init__(self, api: NinjaAPI):
        @api.get(
            "survey/{public_id}/view/",
            response={200: schema.BeltSurveySessionSchema, 403: str},
            tags=self.tags,
        )
        def get_survey_sessions(request, public_id: str):
        ...
        @api.get(
            "survey/view/my-sessions/{character_id}/",
        ...
        def get_my_sessions(request, character_id: int):
            ...
            perms, owner = get_owner_or_none(request=request, character_id=character_id)

            if owner is None:
                return 404, {"error": _("User not found.")}
        ...
        @api.post(
            "survey/{public_id}/manage/delete/",
        ...
        @api.post(
            "survey/{public_id}/snapshot/{snapshot}/manage/delete/",
            response={200: dict, 403: dict, 404: dict},
            tags=self.tags,
        )
