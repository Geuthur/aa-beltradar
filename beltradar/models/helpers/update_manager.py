...
if TYPE_CHECKING:
    # AA Belt Radar
    from beltradar.models.owner import Owner, UpdateStatus
...
class UpdateSection(models.TextChoices):
    BELT_RADAR = "belt_radar", _("Belt Radar Section")
...
class UpdateManager:
    """Manager class to handle update operations for Belt Radar.
    This class provides methods to manage and track update statuses for Belt Radar.

    Args:
        owner (Owner): The owner model (Owner) instance for which the updates are being managed.
