...
class TestAddSurveyForm(NoSocketsTestCase):
    ...
    def test_parse_ore_data_valid(self):
        ...
        self.assertEqual(parsed_entries[0].price_isk, 24200000)
    ...
    def test_parse_ore_data_price_decimal_comma(self):
        ...
        form = AddSurveyForm(data={"raw_data": raw_data})
        self.assertTrue(form.is_valid())
        self.assertEqual(form.cleaned_data["raw_data"].entries[0].price_isk, 24200000)
    ...
    def test_parse_ore_data_space_separated_german_format(self):
        ...
        self.assertEqual(parsed_entries[0].price_isk, 1540000)
    ...
    def test_parse_ore_data_ignores_non_data_info_lines(self):
        ...
        self.assertEqual(parsed_entries[0].price_isk, 52800000)
        ...
        self.assertEqual(parsed_entries[1].price_isk, 30300000)
